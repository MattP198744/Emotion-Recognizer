...
# 2. Define the Model and Label paths
MODEL_PATH = PROJECT_DIR / "models" / "final_emotion_model.keras"
LABEL_PATH = PROJECT_DIR / "models" / "emotion_labels.txt"

# 3. Define and Create the Log directory
LOG_DIR = PROJECT_DIR / "logs"  # This creates a 'logs' folder in your project
LOG_PATH = LOG_DIR / "emotion_log.csv"

# Ensure the logs directory exists on your computer
...
try:
    while True:
        ...
        for face_id, (x, y, w, h) in enumerate(faces):
            ...
            avg_probs[2] *= 1.5  # Give Disgust a 50% boost
            avg_probs[1] *= 1.3  # Give Fear a 30% boost
